# OHDT Header and Announcement Hierarchy

## Case-study status

- Site: Ohio Dealership Technology Association stakeholder website.
- Framework: Astro.
- Hosting: Cloudflare Pages staging project.
- Date: July 13, 2026.
- Human reviewer: Lane Campbell.
- Decision: Approved.
- Approved review candidate: `ohdt-header-review-20260713-a`.
- Promoted staging candidate: `ohdt-stage-20260713-d`.
...
6. Receive explicit approval from Lane Campbell.
7. Promote the approved treatment as a new identified staging candidate.
