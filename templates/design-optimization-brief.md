...
## Route Family and Page Archetype Contract

| Route family | Routes | Reader purpose | Page archetype | Content rhythm | Visual identity | Distinctive selectors |
|---|---|---|---|---|---|---|
| | | | | | | |

- Minimum measured differentiation dimensions:
- Differentiation viewports:
- Approved same-family shared archetypes:
...
- Which actions need explicit clearance from separators, status bands, media, or following regions?
- Which header and hero proportions are appropriate for each route family?
- Which medium-width transitions are most likely to overflow or become cramped?
- Which route-family differences support comprehension rather than decoration?
...
- [ ] Header and hero proportions pass their reviewed interface-quality contracts.
- [ ] Important action groups meet their measured clearance contracts.
...
- [ ] Distinct route families pass the measured structure, layout, palette, typography, and media threshold.
...
- Interface-quality report and result:
- Route and viewport coverage:
- Clearance, header, and hero results:
- Route-family differentiation result:
