...
- A passing machine-readable interface-quality report across every indexable route and the reviewed 1440, 1024, 768, 390, and 320 CSS pixel widths.
- Project-owned route-family and page-archetype contracts, with measured differences in structure, layout, palette, typography, or media between distinct families.
...
2. Run every mandatory core validator, including interface quality, page differentiation, render sharpness, and every browser gate.
