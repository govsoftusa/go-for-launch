...
Visual composition does not replace the whole-page [Interface Quality and Page Differentiation Gate](INTERFACE-QUALITY-AND-PAGE-DIFFERENTIATION.md). Visual composition checks marked artwork internals. Interface quality checks every configured route for control collisions, clipping, overflow, clearance, hero and header proportions, and route-family differentiation.
